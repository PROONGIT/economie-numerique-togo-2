...
TR = {
    ...
    "ov_f1": {"fr": "Réseau physique concentré dans la région Maritime : 90 agences Moov + Togocom pour tout le pays (le fichier « Télécom » fourni est la fusion des deux ; CANAL+ n'a pas d'agence géoréférencée dans ce jeu de données ouvert), dont près de 60% (51/90) situées dans la seule région Maritime (Lomé inclus).",
              "en": "Physical network concentrated in the Maritime region : 90 Moov + Togocom agencies nationwide (the supplied \"Télécom\" file is the merge of both; CANAL+ has no geo-referenced agency in this open dataset), nearly 60% (51/90) located in the Maritime region alone (including Lomé)."},
